...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (profileStr) {
      // User already has a profile, redirect to meal plan
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50">
      <div className="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">SmartMeals</h1>
          <p className="text-gray-600">Plan your meals intelligently</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          By continuing, you agree to SmartMeals Terms of Service
        </p>
      </div>
    </div>
  );
